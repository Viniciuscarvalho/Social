...
public struct EmailVerificationFeature {
    ...
    public struct State: Equatable {
        ...
        var canSendCode: Bool {
            return !isSendingCode && countdown == 0
        }
    ...
    public var body: some ReducerOf<Self> {
        ...
        Reduce { state, action in
            ...
            case .sendVerificationCode:
                ...
                return .run { send in
                    do {
                        try await negotiationClient.sendEmailVerification()
            ...
            case .sendCodeResponse(.success):
                ...
                print("✅ Código de verificação enviado para: \(state.email)")
            ...
            case let .sendCodeResponse(.failure(error)):
                ...
                print("❌ Erro ao enviar código: \(error.userFriendlyMessage)")
                return .none
            ...
            case .verifyCode:
                ...
                return .run { send in
                    do {
                        let verification = try await negotiationClient.verifyEmail(code)
